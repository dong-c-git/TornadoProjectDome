...
create table if not exists ih_user_profile(
    ...
    up_ctime datatime not null default current_timestamp comment '创建时间',
...
create table if not exists ih_house_info(
    ...
    hi_house_unit varchar not null default '' coment '房屋户型',
    ...
    hi_verify_status tinyint not null default '0' comment  '审核状态，0-待审核' ,
    hi_online_status tinyint not null default '1' cooment '0-下线，1-上线',
